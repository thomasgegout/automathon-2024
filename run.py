...
if not os.path.exists(resized_dir):
    ...
    for f in train_files:
        ...
        io.write_video(os.path.join(resized_dir, "train_dataset", f), video, 15, video_codec='h264', audio_array=audio, audio_codec='aac')
    ...
    for f in test_files:
        ...
        video = video.permute(0,2,3,1)
        length = video.shape[0]
        io.write_video(os.path.join(resized_dir, "test_dataset", f), video, 15, video_codec='h264', audio_array=audio, audio_codec='aac')
    ...
    for f in experimental_files:
        ...
        video = video.permute(0,2,3,1)
        length = video.shape[0]
        io.write_video(os.path.join(resized_dir, "experimental_dataset", f), video, 15, video_codec='h264', audio_array=audio, audio_codec='aac')
